...
def test_gw_eigs(parser):
    ...
    sec_eigs_gw = archive.section_run[0].section_single_configuration_calculation[0].gw[0].eigenvalues[0]
    assert sec_eigs_gw.value_X[0][0][7].magnitude == approx(-1.16615227e-17)
